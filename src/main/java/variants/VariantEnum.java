...
public enum VariantEnum {
	...
	SEP_TO_NOV_2023(
			...
			"xda"
	/*
	 * "xbb.1.16.1", "xbb.1.16.9", "xbb.1.5.72", "xbb.1.42.2", "hz.1",
	 * "gk.1.1.1", "xch", "xbb.1.22", "xbb.1.5.10", "hn.4", "xbb.1.16.23",
	 * "ge.1.4", "xbb.1.9.1", "fu.1", "hy.1", "fu.2.1", "eg.5.2", "eg.10.1",
	 * "hh.1", "xbb.1.41.2", "fl.15", "eg.5.1.9", "dv.7.1.4", "jm.2", "hn.6",
	 * "jc.5", "fy.5", "hf.1.2", "gk.2.1", "xbb.2.3.15", "eg.5.2.1",
	 * "xbb.2.3.3", "fy.8", "hv.1.4", "gk.1", "hn.3.1", "gn.1", "xbb.1.9.2",
	 * "fl.20", "xbb.1.16.14", "gs.1", "hk.7", "gj.5", "jc.1", "hk.11",
	 * "xbb.1.5.28", "fl.10.1", "fd.1.1", "xbb.1.16.8", "dv.7.1.5",
	 * "xbb.1.16.2", "eg.2", "hv.1.2"
	 */
	// should be 51
	// watch list:
	// XDD (not numbered)
